...
staffPage: {
  ...
  status: { all: "All Statuses", pending: "Pending", paid: "Paid", active: "Active", inactive: "Inactive", suspended: "Suspended" },
  loadingDrivers: "Loading drivers...", loadingWaiters: "Loading waiters...", loadingPayments: "Loading payments...",
  table: { driver:"Driver", waiter:"Waiter", phone:"Phone", nationalId:"National ID", license:"License", licenseExpiry:"License Expiry", carNumber:"Car Number", carType:"Car Type", role:"Role", reportsTo:"Reports To", eventRate:"Event Rate", status:"Status", actions:"Actions", healthExpiry:"Health Expiry", contractEnd:"Contract End", documents:"Documents", payTo:"Pay To", type:"Type", event:"Event", date:"Date", amount:"Amount", action:"Action", name:"Name", attendance:"Attendance", paymentTo:"Payment To", eventAmount:"Event Amount" },
  actions: { delete:"Delete", cancel:"Cancel", saving:"Saving...", saveChanges:"Save Changes", markAsPaid:"Mark as Paid" },
  payments: { pendingPayments:"Pending Payments", calculatedPerEvent:"Payments are calculated per completed event.", noResults:"No payments match your search." },
  pagination: { showing:"Showing", of:"of", drivers:"drivers", waiters:"waiters" },
  fields: { fullName:"Full Name", phoneNumber:"Phone Number", nationalId:"National ID", licenseNumber:"License Number", carNumber:"Car Number", licenseExpiryDate:"License Expiry Date", carType:"Car Type", status:"Status", eventRate:"Event Rate (EGP)", driverRole:"Driver Role", waiterRole:"Waiter Role", reportsTo:"Reports To", documents:"Documents", healthCertificateExpiry:"Health Certificate Expiry", contractStartDate:"Contract Start Date", contractEndDate:"Contract End Date" },
...
staffPage: {
  ...
  errors: { permissionDenied:"غير مسموح", couldNotLoad:"تعذر تحميل الموظفين.", couldNotMarkPaid:"تعذر تحديد الدفعة كمدفوعة.", noEditPermission:"ليس لديك صلاحية لتعديل الموظفين.", noDeletePermission:"ليس لديك صلاحية لحذف الموظفين.", completeDriver:"يرجى إكمال بيانات السائق.", driverDuplicate:"الرقم القومي أو رقم الرخصة موجود بالفعل.", couldNotSaveDriver:"تعذر حفظ السائق.", completeWaiter:"يرجى إكمال بيانات النادل.", waiterDuplicate:"الرقم القومي موجود بالفعل.", couldNotSaveWaiter:"تعذر حفظ النادل.", driverConnected:"هذا السائق مرتبط بفعاليات أو عمليات توزيع ولا يمكن حذفه.", couldNotDeleteDriver:"تعذر حذف السائق.", waiterConnected:"هذا النادل مرتبط بفعالية ولا يمكن حذفه.", couldNotDeleteWaiter:"تعذر حذف النادل." }
},
...
reportsPage: {
  title: "التقارير",
  subtitle: "إنشاء وتصدير تقارير النظام",
  export: "تصدير",
